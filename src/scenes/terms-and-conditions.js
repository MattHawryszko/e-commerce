    ...
    return (
      <div className="w-100">
        ...
        <div className="container nav-padding">
          ...
          <Title class="display-4" dash="dash-yellow" text="Terms and Conditions"/>
          <div className="row py-5">
            <p className="text-grey">No terms and conditions have been written for this demo website. This website is for demo purposes only and none of the text, images, or products associated with this site should be used for commercial purposes unless provided written consent from the original owners.</p>
